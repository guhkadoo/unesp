...
\input{chapters_proposta/introducao}
\input{chapters_proposta/problema}
\input{chapters_proposta/justificativa}
\input{chapters_proposta/objetivos}
\input{chapters_proposta/metodo}
\input{chapters_proposta/cronograma}

% --------------------------------------------------------
% REFERÊNCIAS BIBLIOGRÁFICAS
% --------------------------------------------------------

\bibliography{chapters_proposta/referencias}
